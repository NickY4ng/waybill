...
const CACHE_KEY = 'cargo_flow_analysis_html';
...
/**
 * 【输入：无 | 输出：HTML字符串 | 约束：调用大模型API生成货物流向分析报告，每次调用创建新会话，使用缓存机制】
 */
export async function generateCargoFlowAnalysis(): Promise<string> {
